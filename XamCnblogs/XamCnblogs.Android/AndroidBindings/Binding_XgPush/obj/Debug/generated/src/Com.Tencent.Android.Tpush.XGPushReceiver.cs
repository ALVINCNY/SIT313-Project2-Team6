...
namespace Com.Tencent.Android.Tpush {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.android.tpush']/class[@name='XGPushReceiver']"
	[global::Android.Runtime.Register ("com/tencent/android/tpush/XGPushReceiver", DoNotGenerateAcw=true)]
	public partial class XGPushReceiver : global::Android.Content.BroadcastReceiver {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/tencent/android/tpush/XGPushReceiver", typeof (XGPushReceiver));
		...
		protected XGPushReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.android.tpush']/class[@name='XGPushReceiver']/constructor[@name='XGPushReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe XGPushReceiver ()
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.Android.Tpush.XGPushReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.Android.Tpush.XGPushReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.android.tpush']/class[@name='XGPushReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
