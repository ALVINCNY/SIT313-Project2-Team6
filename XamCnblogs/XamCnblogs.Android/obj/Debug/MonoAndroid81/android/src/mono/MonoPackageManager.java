...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamCnblogs.Android.dll" comes first in this list. */
		"XamCnblogs.Android.dll",
		"Bugly.dll",
		"FFImageLoading.dll",
		...
		"Square.OkHttp3.dll",
		"Square.OkIO.dll",
		"UMeng.Android.Shares.dll",
		"UMeng.Share.Android.dll",
